...
| <a name="input_automation_username"></a> [automation\_username](#input\_automation\_username) | Name of the system user performing the automation (the Github user that runs the pipeline) | `string` | n/a | yes |
